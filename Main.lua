...
while true do
    ...
    if action == 'Upgrades' then
        ...
        Emet.Upgrades:message('a - Heal 10%% (1 Emet; 0 Met)')
        Emet.Upgrades:message('b - Heal 50%% (5 Emet; 0 Met)')
        ...
        if upgrades then
            for i=1, #upgrades do
                if Emet.Player:canUpgrade(i) then
